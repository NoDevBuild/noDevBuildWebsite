...
const Header = () => {
  ...
  return (
    <header className='ixed w-full top-0 z-50 max-w-screen overflow-hidden'>
      <div className='bg-white shadow-sm relative z-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex justify-between items-center h-16'>
            <Link to='/' className='flex items-center'>
              <img
                src='/noDevBuild-logo.png'
                alt='noDevBuild'
            ...
            <nav className='hidden md:flex items-center space-x-8'>
              ...
              <Link
                ...
                className={`text-gray-700 hover:text-blue-600 ${
                  location.pathname === '/startup-builder'
                    ? 'text-blue-600'
                    : ''
                }`}
              >
      ...
      {showMobileMenu && (
        ...
        >
          <div
            ref={mobileMenuRef}
            className='absolute right-0 w-full max-w-xs top-0 h-full w-[300px] bg-white shadow-xl transform transition-transform duration-300'
